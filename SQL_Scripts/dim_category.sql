...
FROM dim_category_add_parent_name WHERE category_level = 1
...
select            
  *
  ...
  , 0 AS category_level_4_key
  , 'Undefined' AS category_level_4_name
FROM dim_category_add_parent_name WHERE category_level = 2
...
LEFT join    dim_category_add_parent_name AS l12
  ON l3.parent_category_key = l12.category_key WHERE l3.category_level = 3
...
LEFT join    dim_category_add_parent_name AS l3   ON l4.parent_category_key = l3.category_key LEFT join    dim_category_add_parent_name AS l12   ON l3.parent_category_key = l12.category_key
...
LEFT join    category_levels AS dim_category
